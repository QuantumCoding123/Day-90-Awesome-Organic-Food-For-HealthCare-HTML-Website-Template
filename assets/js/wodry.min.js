...
(function () {
    ...
    a = jQuery, a.fn.extend({
        wodry: function (c) {
            var d, e, f, g, h;
            return null == c && (c = {}), e = a.extend({}, c), null == e.separator && (e.separator = "|"), null == e.delay && (e.delay = 2e3), null == e.animationDuration && (e.animationDuration = 500), null == e.animation && (e.animation = "rotateY"), null == e.callback && (e.callback = function () {}), null == e.shift && (e.shift = {}), null == (f = e.shift).x && (f.x = 0), null == (g = e.shift).y && (g.y = 0), null == (h = e.shift).z && (h.z = 0), null == e.styles && (e.styles = []), d = {
                rotateY: {
                ...
                return i = a(this), f = [], a.each(i.text().split(e.separator), function (a, b) {
                    return f.push(b)
                }), m = 0, e.styles.length > 0 ? i.html("<span class='" + e.styles[0] + "'>" + f[0] + "</span>") : i.text(f[0]), k = function () {
                    return m = (m + 1) % e.styles.length
                }, j = "front-face", g = "back-face", l = function (a, c) {
                    var d, e, f, g, h, i, j, k, l, m, n;
                    for (i = {}, g = {}, l = 0, m = a.length; m > l; l++) h = a[l], d = a.indexOf(h), g[h] = c[d];
                    if (a.length === c.length) {
                        for (h in g) b.call(g, h) && (j = g[h], n = ["-webkit-" + h, "-moz-" + h, "-o-" + h], k = n[0], e = n[1], f = n[2], i[k] = j, i[e] = j, i[f] = j, i[h] = j);
                        return i
                    }
                }, c = function (b, c, d, e) {
                    return c.html(""), a("<span class='" + j + "'>" + d + "</span>").appendTo(c), a("." + c.context.className + " .front-face").css(l(["transform"], [b.front_transform])), a("<span class='" + g + "'>" + e + "</span>").appendTo(c), a("." + c.context.className + " .back-face").css(l(["transform"], [b.back_transform])), c.wrapInner("<span class='wodry-flipping' />").find(".wodry-flipping").hide().show().css(l(["transform", "transition"], [b.action.transform, b.action.transition])), b.isCoplex ? setTimeout(function () {
                        return a("." + c.context.className + " .front-face").remove()
                    }, 1) : void 0
                }, h = function () {
                    var b, h;
                    return e.styles.length > 0 && (j = "front-face " + e.styles[m], g = "back-face " + e.styles[k()]), i.find(".back-face").length > 0 && i.html(i.find(".back-face").html()), h = i.text(), b = a.inArray(h, f), b + 1 === f.length && (b = -1), c(d[e.animation], i, h, f[b + 1])
